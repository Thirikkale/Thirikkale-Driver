class ApiConfig {
  ...
  static const String baseUrl = 'http://10.29.85.103:8081/user-service/api/v1';
...
class DriverEndpoints {
  ...
  static String processingStatus(String driverId) =>
      ApiConfig.getProcessingStatus(driverId);
