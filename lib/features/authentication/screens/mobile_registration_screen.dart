...
import 'package:thirikkale_driver/features/authentication/screens/otp_verification_screen.dart';
import 'package:thirikkale_driver/features/authentication/widgets/custom_phone_input_field.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<AuthProvider>(
      builder: (context, authProvider, child) {
        // Use either local loading or provider loading
              ...
              child: GestureDetector(
                ...
                child: Column(
                  children: [
                    // Top image
                    Image.asset(
                      'assets/images/driver_mobile_registration_bg.png',
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed:
                              (_isFormValid && !isLoading) ? _sendOTP : null,
