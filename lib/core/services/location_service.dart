...
class LocationService {
  ...
  static StreamSubscription<Position> watchLocation({
    ...
    _positionStreamSubscription = getPositionStream().listen(
      (Position position) async {
        try {
          ...
          onError('Failed to update location: ${e.toString()}');
        }
      },
      onError: (error) {
  ...
  static void stopWatchingLocation() {
    _positionStreamSubscription?.cancel();
